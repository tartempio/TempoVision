...
- **Mise à jour automatique** : Les données sont rafraîchies toutes les 2 heures.
...
Chaque entité contient des attributs tels que la date précise et les probabilités de couleurs. Si l'option est activée, des capteurs de type `sensor.tempo_j_x_probabilite_rouge` seront également créés.
